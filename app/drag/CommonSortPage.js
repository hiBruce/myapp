...
import { Board } from 'react-native-draggable-board';
const deviceWidth = Dimensions.get('window').width
const childrenWidth = deviceWidth / 8;
const childrenHeight = deviceWidth / 8;
const itemWidth = 72
const itemHeight = 36
const sortWidth = deviceWidth
const items = [
    { text: '常用', isSelect: false },
...
export default class CommonSortPage extends Component {
    ...
    renderSelectedItemView = (item, index) => {
        const clearIcon = this.state.isEditState ? <Image style={styles.selected_item_icon} source={require('./../../imgs/delete.png')} /> : undefined
        return (

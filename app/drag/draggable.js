...
const items = [
    ...
    { text: '音频', isSelect: true },
    { text: '深圳', isSelect: true },

]
const fixedItems = [0];

export default class SortAndFixedPage extends Component {
        ...
        return (
            <ScrollView
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Text style={styles.hurdle_title}>{'常用'}</Text>
                    <DragSortableView
    ...
    renderSelectedItemView = (item, index) => {
        ...
        const clearIcon = this.state.isEditState && !isFixed ? <Image style={styles.selected_item_icon} source={require('./../../imgs/delete.png')} /> : undefined
        return (
        ...
        return (
            <View style={styles.selected_container}>
                <View style={styles.unselected_item}>
                    <Image style={styles.unselected_item_icon} source={require('./../../imgs/delete.png')} />
